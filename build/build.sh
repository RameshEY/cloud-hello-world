...
sed -i 's/{RELEASE}/'"$tag"'/g' ${WORKDIR}src/main/resources/application-test.properties
sed -i 's/{RELEASE}/'"$tag"'/g' ${WORKDIR}src/main/resources/application-production.properties
mvn package
